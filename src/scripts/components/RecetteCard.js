export default class RecetteCard {
    ...
    createCard() {
        ...
        const cardContent = `
            <article class="card relative w-400 h-400 rounded-lg overflow-hidden bg-white m-4 lg:w-11/12 h-730" data-id=${this.recette.id} aria-labelledby="recette-title-${this.recette.id}">
                ${this.recette.time > 0
                ...
                <div class="h-1/2 flex items-center justify-center overflow-hidden lg:h-1/3">
                ...
                <div class="h-1/2 p-4 overflow-y-auto lg:h-2/3">
                    ...
                    <div class="card_infos_instructions mb-2">
                        <h3 class="text-lg font-bold text-gris font-manrope uppercase font-gris-light tracking-wider">Recette</h3>
                    ...
                    <div class="card_infos_ingredients">
                        <h3 class="text-lg font-bold text-gris font-manrope uppercase font-gris tracking-wider">Ingrédients</h3>
                        <div>
                    ...
                    return `
                                    <li aria-label="${ingredient.ingredient}: ${ingredient.quantity} ${ingredient.unit}">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-gris">${ingredient.quantity} ${ingredient.unit}</span>
                                        </div>
                                    </li>
                                `;
                } else {
